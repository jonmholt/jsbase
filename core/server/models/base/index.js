// # Base Model
// This is the model from which all other models extend. The model is based on Bookshelf.Model, and provides
// several basic behaviours such as UUIDs, as well as a set of Data methods for accessing information from the database.
//
// The models are internal, only the API and some internal functions such as migration and import/export
// accesses the models directly. All other parts of the app, including the frontend and admin UI are only
...
// ### appBookshelf
// Initializes a new Bookshelf instance called appBookshelf, for reference elsewhere in the app.
...
appBookshelf.Model = appBookshelf.Model.extend({
    ...
    */
    generateSlug: function generateSlug(Model, base, options) {
        ...
        if (baseName === 'user' && options && options.shortSlug && slugTryCount === 1 && slug !== 'app-owner') {
            longSlug = slug;
...
// Export appBookshelf for use elsewhere
