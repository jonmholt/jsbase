...
User = appBookshelf.Model.extend({
    ...
    */
    ...
    /**
     * ### Find One
     * @extends appBookshelf.Model.findOne to include roles
     * **See:** [appBookshelf.Model.findOne](base.js.html#Find%20One)
     */
    ...
    /**
     * ### Edit
     * @extends appBookshelf.Model.edit to handle returning the full object
     * **See:** [appBookshelf.Model.edit](base.js.html#edit)
     */
     ...
     * @extends appBookshelf.Model.add to manage all aspects of user signup
     * **See:** [appBookshelf.Model.add](base.js.html#Add)
     */
    add: function add(data, options) {
        ...
        function getAuthorRole() {
            return appBookshelf.model('Role').findOne({name: 'Author'}, _.pick(options, 'transacting')).then(function then(authorRole) {
    ...
    setup: function setup(data, options) {
        ...
        return generatePasswordHash(data.password).then(function then(hash) {
            ...
            return Promise.join(
                ...
                appBookshelf.Model.generateSlug.call(this, User, userData.name, options)
            );
    ...
    transferOwnership: function transferOwnership(object, options) {
        ...
        return Promise.join(appBookshelf.model('Role').findOne({name: 'Owner'}),
        ...
        .then(function then(results) {
            ...
            return Promise.join(appBookshelf.model('Role').findOne({name: 'Administrator'}),
