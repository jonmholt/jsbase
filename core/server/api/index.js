...
//
// The JSON API is integral to the workings of the app, regardless of whether you want to access data internally 
// or from an external app, you'll use the JSON API to do so.
