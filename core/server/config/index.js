...
ConfigManager.prototype.load = function (configFilePath) {
    ...
    self._config.paths.config = process.env.APP_CONFIG || configFilePath || self._config.paths.config;
...
ConfigManager.prototype.displayDeprecated = function (item, properties, address) {
    ...
    if (item.hasOwnProperty(property)) {
        ...
        helpText = 'Please check config.example.js for the most current example';
